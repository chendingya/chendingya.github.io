---
title: 系统架构2-质量属性Quality Attributes
date: 2024-05-02 10:10:44
tags: 
 系统架构
categories: 
 软件系统设计
...
## 为什么软件架构是重要的 Why is software architecture important?
...
4. ==架构促进/阻碍**质量属性的实现**==，比如==灵活性、安全性、易用性== Architecture facilitates/ hinders achievement of quality attributes, e.g.modifiability, security, usability etc.

5. ==架构会影响质量==，但由于涉及许多其他因素，因此==可能**无法保证**质量==。Architecture influences qualities, but may not guarantee them as there are a number of other factors involved.
...
7. ==架构将更改分为三种类型== Architecture categorise changes into three types:
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/1.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/1.png)
...
### 移动手机系统架构 Mobile Phone System Architecture

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/2.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/2.png)

### 洗衣机架构 Washing Machine Architecture

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/3.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/3.png)
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/4.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/4.png)

需求中往往存在有开发人员和用户的矛盾，我们需要将这一个部分进行转化

## 功能性需求 Functional Requirements

1. ==功能性需求定义了**系统必须做什么**==并且==强调了**系统如何提供价值**给涉众== Functional requirements state what the system must do and address how the system provides value to the stakeholders.
...
4. 非功能性需求分为两大类：There are two broad categories ot non-functional requirements:
   1. ==在执行过程中**可观察**(**外部**)==：系统满足其行为要求的程度如何？ 例如==性能，安全性，可用性，可用性==等。Observable (External) during execution: How well a system satisties its behavioural requirements? e.g., performance, security, availability, usability etc.
   2. ==执行期间**不可观察**(**内部**)==：==系统的维护，集成或测试有多容易==？ 例如，==可修改性，可移植性，可重用性，可测试性==等。Not observable (Internal) during execution: How easily a system can be maintained, integrated, or tested? e.g., modifiability, portability, reusability, testability etc.
...
8. 这就是为什么==软件体系结构被认为是解决质量问题的最合适的层次== That is why software architecture is considered the most appropriate level of addressing the quality Issues.
...
### 确定质量属性 Specifying Quality Attributes
...
3. 方案是具有一定结构的简单句子。
   ...
   场景的两个主要类别是：Scenarios are simple descriptions with certain structure. Two main classes of scenarlos are:
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/5.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/5.png)
...
8. 刺激和响应发生在一个环境中：系**统正常运行、系统过载、系统受到攻击、系统网络等出现了故障。**
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/6.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/6.png)
...
# 质量属性和策略 Quality Attributes & Tactics

## ==可用性== Availability

1. 可用性是应用程序的**关键**要求 Key requirement for most IT applications
2. 度量方式：以==所需的可用时间比例==来衡量，例如 Measured by the proportion of the required time it is useable, e.g.
...
3. 相关性：==与应用程序的可靠性==有关 Related to an application’s reliability
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/8.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/8.png)
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/9.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/9.png)
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/10.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/10.png)

### 可用性通用方案 Availability General Scenario

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/11.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/11.png)
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/12.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/12.png)
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/13.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/13.png)
...
| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/14.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/14.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/15.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/15.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                                              |                                                              |

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/60.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/60.png)
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/16.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/16.png)
...
| 反应     | 该请求(适当地)被适当拒绝和通知实体(人员或系统)。<br/>该请求(适当地)被接受，并且信息成功地交换了。<br/>请求由一个或多个所涉人员或者系统记录。 |
| 反应测量 | 正确处理信息交流的百分比<br/>正确拒绝信息交换的百分比        |

### 互操作性的样本方案 Interoperability Sample Scenario

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/17.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/17.png)

### . 互操作性的策略 Interoperability Tactics

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/18.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/18.png)
...
| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/19.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/19.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/20.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/20.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                                              |                                                              |
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/21.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/21.png)
...
| 反应     | 作出修改<br/>试验修改<br/>部署修改                           |
| 度量     | 费用如下：<br/>受影响工件的数量、大小和复杂性<br/>努力<br/>日历时间<br/>金钱(直接支出或机会成本)<br/>本修改影响其他功能的程度或<br/>质量属性<br/>新缺陷 |

### 可修改性的样本方案 Modifiability Sample Scenario

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/22.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/22.png)

###  可修改性的策略 Modifiability Tactics

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/23.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/23.png)
...
3. Reduce Coupling：
   1. ==**封装**为模块引入了显式**接口**，并减少了对一个模块的更改**传播**到其他模块的可能==性。Encapsulation introduces an explicit interface to a module, and reduces the probability that a change to one module propagates to other modules.
...
| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/24.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/24.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/25.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/25.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                                              |                                                              |
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/26.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/26.png)
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/27.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/27.png)

### 性能的策略 Tactics for Performance

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/28.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/28.png)
...
1. 在需求方面 On the demand side
   ...
   3. 如果不是所有事件都同样重要，则对事件==进行**优先级**排序==。Prioritize events if not all events are equally important.
   4. 通过==使用**中介**==来增加处理事件流的资源，从而减少开销 Reduce overhead by using intermediaries to increase the resources in processing an event stream
2. 在资源方面 On the resource side
   ...
   3. 维护多个计算副本：使用==负载平衡器==将新工作分配给可用的==**重复**服务器==之一。Maintain multiple copies of computations: Use load balancer to assign new work to one of the available duplicate servers.
...
| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/29.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/29.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/30.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/30.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                                              |                                                              |

## 安全性 Security

1. 安全性衡量==系统**保护**数据和信息免遭**未授权访问**==的能力，同时仍提供对授权人员和系统的访问权限。Security measures system’s ability to protect data and information from unauthorized access while still providing access to people and systems that are authorized.
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/31.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/31.png)
...
| 反应     | **交易是以这样的方式进行的**<br/>数据或服务受到保护，不受未经授权的访问。<br/>数据或服务不会未经授权而被操纵。<br/>一项交易的当事方得到了明确的确认。<br/>交易各方不能否认其参与。<br />数据、资源和系统服务将用于合法使用。<br/>**系统通过以下方式跟踪其中的活动**：<br/>记录存取或修改<br/>记录访问数据、资源或服务的尝试<br/>通知适当的实体(人员或系统)<br/>明显的攻击正在发生 |
| 度量     | 当一个特定的组件或数据值被破坏。<br/>在检测到攻击之前，过了多长时间<br/>多少次攻击被抵抗<br/>从一次成功的攻击中恢复需要多长时间<br/>有多少数据易受特定攻击的影响？ |

###  安全性的样本方案 Security Sample Scenario

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/32.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/32.png)

###  安全性的策略 Security Tactics

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/33.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/33.png)
...
| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/34.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/34.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/35.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/35.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                                              |                                                              |
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/36.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/36.png)

### 可测试性的通用方案 Testability General Scenario

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/37.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/37.png)
...
| 度量     | 努力查找故障或故障类别，努力实现给定百分比的状态空间覆盖率，故障的概率由下一个揭示<br/>测试、执行测试的时间、检测故障的工作量、测试中最长依赖链的长度、准备测试环境的时间长度、风险暴露的降低 |

###  可测试性的样本方案 Testability Sample Scenario

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/38.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/38.png)

### 可测试性的策略 Testability Tactcs

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/39.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/39.png)
...
2. **限制复杂度：复杂的软件更难测试，因为它的操作状态空间很大**，并且在大状态空间中重新创建精确状态更加困难。Limit complexity: Complex software is harder to test, because its operating state space is very large and more difficult to re-create an exact state in a large state space.
   ...
   2. ==**限制不确定性**==-限制行为复杂性 Limit nondeterminism - limiting behavioral complexity.
      1. 非确定性系统更难测试。Nondeterminism systems are harder to test.

### 可测试性的检查列表 Checklist for Testability Design and Analysis

| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/40.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/40.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/41.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/41.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                                              |                                                              |
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/42.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/42.png)
...
| 度量     | 任务时间、错误数、完成的任务数量、用户满意度、用户收益<br />知识，成功运营与总运营的比率，或发生错误时丢失的时间或数据量 |

###  易用性的样本方案 Usbility Sample Scenario

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/43.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/43.png)

###  易用性的策略 Usability Tactics

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/44.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/44.png)
...
| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/45.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/45.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/46.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/46.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                                              |                                                              |

## 更多的能力 X-ability

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/47.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/47.png)
...
2. MoSCoW样式：[MoSCoW的样式说明](https://blog.csdn.net/cheny_com/article/details/6358456)：使用四个级别来定义一个需求的优先级程度
...
[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/48.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/48.png)

1. 将scenario使用量化的方式来描述，之后才可以使用测试等方式来确定是否实现了要求。
2. 逐渐对质量需求进行分解，分解到含有量化指标为止。
3. 然后将分解的结果进行细化

##  基于决策来发现ASR的方法 Persona-Based Approach to exploring ASRs

###  结合ASR工作 Working with ASRs
...
###  TraceLab中的ASR ARSs in TraceLab
...
###  考虑折中 Competing Tradeoffs

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/49.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/49.png)

### 传统的HCI角色 Traditional HCI Personas
...
###  精通架构的角色(精简版) Architecturally-Savvy(Lite)

[![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/50.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/50.png)

###  几个例子

| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/51.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/51.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/52.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/52.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/53.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/53.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/54.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/54.png) |
| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/55.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/55.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/56.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/56.png) |
| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/57.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/57.png) | [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/58.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/58.png) |
| [![img](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/59.png)](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec13/59.png) |                                                              |